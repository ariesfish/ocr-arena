...
from ..postprocess.base_post_processor import BasePostProcessor
from ..utils.logging import get_logger, get_profiler
from ..utils.result_postprocess_utils import (
    clean_repeated_content,
    clean_formula_number,
)

if TYPE_CHECKING:
    from ..config import ResultFormatterConfig
...
class ResultFormatter(BasePostProcessor):
    ...
    Example:
        from ocr_arena.config import ResultFormatterConfig
